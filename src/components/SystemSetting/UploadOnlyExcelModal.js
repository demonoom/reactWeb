...
import UploadOnlyExcelComponents  from './UploadOnlyExcelComponents';
...
class MakeDingModal extends React.Component {
    ...
    upLoad() {
        ...
        window.__calmUploadOnlyExcel__(arr, callbackId);
        //设置model关闭
        ...
        return (
            ...
            >
                <div className="noomUpLoadFile_wrap">
                    <UploadOnlyExcelComponents 
                            callBackParent={this.getUploadedImgList}
