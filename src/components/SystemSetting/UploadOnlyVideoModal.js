...
import UploadOnlyVideoComponents  from './UploadOnlyVideoComponents';
...
class MakeDingModal extends React.Component {
    ...
    upLoad() {
        ...
        window.__calmUploadOnlyVideo__(arr, callbackId);
        //设置model关闭
        ...
        return (
            ...
            >
                <div className="noomUpLoadFile_wrap">
                    <UploadOnlyVideoComponents callBackParent={this.getUploadedImgList}
