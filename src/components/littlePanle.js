        ...
        addOrderBtn(){
            if (!$('.ant-layout-header .lpmgrbtn').length) {
                $('.ant-layout-header > div').append("<div class='lpmgrbtn'>" +
                    "<a onclick='LP.orderAll()'><i class='iconfont'>&#xe648;</i>复位</a>" +
                    "<a onclick='LP.delAll()' class='del'><i class='iconfont'>&#xe62f;</i>删除</a>" +
                    "<a onclick='enterFull()' class='enterFull'><i class='iconfont'>enter</i></a>" +
                    "<a onclick='exitFull()' class='exitFull'><i class='iconfont'>exit</i></a>" +
                    "</div>");
            }
        },
        delAll(){
