...
class KnowledgePointModal extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.getKnowledgeInfoList = this.getKnowledgeInfoList.bind(this);
    ...
    /**
     * 获取知识点列表
     * public String getKnowledgeInfoList(String pageNo, String knowledgeInfoName)
     * @param data
     * @return
     */
                        ...
                        <div className="ant-transfer">
                            ...
                            <div className="select_knoledge">
                                ...
                                <Col span={4} className="right_look">
                                    <Button type="primary" className="calmAddButton calmBorderRadius roe-t-f-left add-2-btn"
