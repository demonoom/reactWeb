...
var CkEditorWithWordPasterComponents1 = React.createClass({
    componentDidMount(){
  ...
  render : function(){
    return (
      <div>
          <textarea id="answer_content" className="ckeditor" rows="10" name="subjectsLib.colAnswer">
                            </textarea>
      </div>
    )
  }
})
export default CkEditorWithWordPasterComponents1;
