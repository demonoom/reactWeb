...
class SchoolGroupMenu extends React.Component {
    ...
    buildMenuPart (part) {
        ...
        for(var i = 0;i < part.length;i++) {
                ...
                partMenu = <SubMenu className="schoolgroup_menu_c" key={part[i].id} title={<span><Icon type="caret-down"  className="schoolgroup_down_arrow" /><Icon type="folder" /><span>{part[i].name}</span><Icon type="edit" onClick={this.editRole.bind(this,part[i].id,event)}/></span>}>
