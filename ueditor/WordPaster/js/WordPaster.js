...
var WordPasterConfig = {
	...
	, "AppPath"			    : ""
	, "IcoPath"			    : "http://www.ncmem.com/products/word-imagepaster/ckeditor353/WordPaster/"
	...
	//Chrome
	, "CrxName"		        : "chrWordPstSXLY"
	, "MimeTypeChr"	        : "application/chrWordPstSXLY"
	, "CrxPath"		        : "http://www.maaee.com/uploadFile/WordPaster.crx"
	, "ExePath"		        : "http://www.maaee.com/uploadFile/WordPaster.exe"
};
...
function PasterManager()
{
	...
	this.Load = function()
	{
		...
		*/
		...
		acx += '<img name="ico" id="infIco" alt="进度图标" src="' + this.Config["IcoPath"] + 'upload.gif" /><span name="msg">图片上传中...</span><span name="percent">10%</span>';
		acx += '</div>';
